...
/// <summary>
/// Command to move an application to under review status.
/// </summary>
...
/// <summary>
/// Handler for ReviewApplicationCommand.
/// </summary>
public sealed class ReviewApplicationCommandHandler : IRequestHandler<ReviewApplicationCommand, bool>
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="ReviewApplicationCommandHandler"/>.
    /// </summary>
    ...
    /// <inheritdoc/>
    public async Task<bool> Handle(ReviewApplicationCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidOperationException("Cannot review applications while organization status is suspended.");
        }
        ...
        application.Review(actorUserId, now, request.Notes);

        var auditLog = AuditLog.Create(
            actorId: actorUserId,
            action: AuditActions.ApplicationReviewed,
        ...
        _outboxService.Write(new RecruitmentApplicationReviewedDomainEvent(
            application.Id,
            application.JobPostingId,
