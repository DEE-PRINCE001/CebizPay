...
/// <summary>
/// Command to accept a candidate application (extend offer).
/// </summary>
...
{
    /// <summary>
    /// Initializes validation rules for AcceptApplicationCommand.
    /// </summary>
...
/// </summary>
public sealed class AcceptApplicationCommandHandler : IRequestHandler<AcceptApplicationCommand, bool>
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="AcceptApplicationCommandHandler"/>.
    /// </summary>
    ...
    public async Task<bool> Handle(AcceptApplicationCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidOperationException("Cannot accept applications while organization status is suspended.");
        }
        ...
        application.Accept(actorUserId, now, request.Notes);

        var auditLog = AuditLog.Create(
            actorId: actorUserId,
            action: AuditActions.ApplicationAccepted,
        ...
        _outboxService.Write(new RecruitmentApplicationAcceptedDomainEvent(
            application.Id,
            application.JobPostingId,
