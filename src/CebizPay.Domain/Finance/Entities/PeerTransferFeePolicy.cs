...
/// <summary>
/// Domain entity representing a versioned platform peer-transfer fee policy.
/// Only one policy may be active at a time. Historical policies are preserved immutably.
/// Rounding strategy: MidpointRounding.AwayFromZero, 2 decimal places (e.g. ₦50.00).
/// </summary>
public class PeerTransferFeePolicy
{
    ...
    /// <summary>
    /// Decimal percentage rate (e.g. 0.01 = 1%).
    ...
    private PeerTransferFeePolicy() { } // EF Core

    /// <summary>
    /// Creates a new peer-transfer fee policy with invariant validation.
    /// </summary>
    ...
    public static PeerTransferFeePolicy Create(
        FeePolicyMode mode,
        ...
        DateTime effectiveFrom)
    {
        ...
        return new PeerTransferFeePolicy
        {
            Id = Guid.NewGuid(),
            Mode = mode,
